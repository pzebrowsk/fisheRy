...
```{r fig.height=9}
pop$verbose = T
nsteps = 500             # Let's simulate for 200 years
...
temp[(nsteps/2+1):nsteps] = seq(5.61,12, length.out=nsteps/2)
...
res = simulate(0, 45, F)
matplot(cbind(dat$ssb/1e9, res$summaries$SSB[1:200]/1e9), ylab="SSB (MT)", xlab="Year", col=c("cyan", "black"), lty=1, type=c("o","l"), pch=1)
