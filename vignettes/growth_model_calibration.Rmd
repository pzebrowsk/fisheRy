...
plot(fishLen(c)~seq(0,ny), xlab="Age", ylab="Length", type="l", lwd=2)
```
...
points(fishLen(c)~seq(0,ny), xlab="Age", ylab="Length", type="l", lwd=2)
```
...
plot(diff(fishLen(c))~seq(1,ny), xlab="Age", ylab="dL", type="l", lwd=2)
