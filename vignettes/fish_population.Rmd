...
```{r}
pop$par$n = 5e5  # Each superfish contains 500,000 fish
...
```{r}
pop$init(1000)  # initialize the population with 1000 agents (superfish)
```
...
for (i in 2:nsteps){
  v = pop$update()       # Update all fish over 1 year 
