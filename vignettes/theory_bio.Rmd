...
growth_trajectories = function(beta1=NULL, beta2=NULL){
...
```{r}
dat_full = growth_trajectories()
```

## Decision to mature

Decision to mature is defined by a probabilistic maturation reaction norm (PMRN), with a probability of maturing in the next year depending on age $a$ and length $l$,* given by the following equation.

$$
m(a,l_a) = \frac{1}{1 + e^{-\left(\frac{l_{a} - (s_{m}a + i_{m})}{d_{m}}\right)}},
$$
