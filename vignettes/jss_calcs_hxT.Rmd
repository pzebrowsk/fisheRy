...
for (i in 1:4){
  image(x=hvec, y=tvec, z=utils[,1,,i], col=scales::viridis_pal()(100), zlim=c(0,1), main=c("ssb","yield","employment","profit")[i])
}
...
for (i in 1:5){
  image(x=hvec, y=tvec, z=scs[,1,,i], col=scales::viridis_pal()(100), zlim=c(0,1), main=c("Industrial", "Artisanal", "Emp. policymakers", "Profit. policymakers", "Conservationists")[i])
}
