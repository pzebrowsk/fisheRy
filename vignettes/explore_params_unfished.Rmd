...
### Add density dependence in growth model (tuned parameters, old mort, fec)
...
```{r}
explore(beta1 = -7.07e-5, beta2 = 0.178, s0 = 0.017, Bhalf = 7e9, gm = 1, oldmat = F, oldmor = T, oldfec = F, superfish = 60e6)
```
...
```{r}
explore(beta1 = -7.07e-5, beta2 = 0.178, s0 = 0.09, Bhalf = 7e12, gm = 1, oldmat = F, oldmor = F, oldfec = F, superfish = 60e6)
```